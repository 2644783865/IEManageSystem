...
namespace IEManageSystem.Api.Startup
{
    ...
    public class IEManageSystemApiModule: AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public IEManageSystemApiModule(IHostingEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(IEManageSystemApiModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            using (var unitOfWork = unitOfWorkManager.Begin())
            {
                ...
                apiAuthorizationConfiguration.RegisterApiSingle(typeof(IEManageSystemApiModule).GetAssembly());
