        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Padding = table.Column<string>(nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Menus",
                columns: new[] { "Id", "CompositeMenuId", "Discriminator", "DisplayName", "Icon", "Name" },
                values: new object[,]
                {
                    { 1, null, "CompositeMenu", "首页", "oi-home", "Home" },
                    { 2, null, "CompositeMenu", "游戏", "oi-dial", "Game" },
                    { 3, null, "CompositeMenu", "技术文档", "oi-document", "Document" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Menus",
                columns: new[] { "Id", "CompositeMenuId", "Discriminator", "DisplayName", "Icon", "Name", "PageId" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "PageData",
                columns: new[] { "Id", "Name", "PageBaseId", "Title" },
                values: new object[] { 1, "Home", 1, "首页" });
