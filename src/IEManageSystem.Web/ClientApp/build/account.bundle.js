...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Account/account.jsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/Account/Content.jsx":
/*!*********************************!*\
  !*** ./src/Account/Content.jsx ***!
  \*********************************/
...
var Content = function (_React$Component) {
	...
	function Content(props) {
		...
		var imgsrc = "/Api/Account/GetVerificationCode/?date=" + new Date();
	...
	_createClass(Content, [{
		...
		key: "loginCall",
		value: function loginCall(data) {
			if (data.isSuccess == true) {
				if (data.redirectHref == null || data.redirectHref == "") {
					// 跳转管理中心
					var manageHomeUrl = $("#manageHomeUrl").attr("value");
		...
		value: function register() {
			var PasswordR = this.state.PasswordR;
			var PasswordRC = this.state.PasswordRC;
			...
			if (this.state.LoginPanelState == LoginPanelState.Login) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: "col-md-12" },
						_react2.default.createElement("div", { className: "col-md-12 error text-danger" }),
						_react2.default.createElement(
							"div",
							null,
							_react2.default.createElement(
								"form",
								{ id: "loginform", className: "form-inline" },
								_react2.default.createElement(
									"h6",
									null,
									"\u7EE7\u7EED\u4F60\u7684\u65C5\u884C..."
								...
								_react2.default.createElement(
									...
									_react2.default.createElement("input", { value: this.state.AccountIDL, onChange: function onChange(event) {
											return _this2.setState({ AccountIDL: event.target.value });
										}, type: "text", className: "form-control", id: "AccountIDL", name: "AccountID" })
								),
								_react2.default.createElement(
									"div",
									{ className: "w-100" },
									...
									_react2.default.createElement("input", { value: this.state.PasswordL, onChange: function onChange(event) {
											return _this2.setState({ PasswordL: event.target.value });
										}, type: "password", className: "form-control", id: "PasswordL", name: "Password" })
								),
								_react2.default.createElement(
									"div",
									...
									_react2.default.createElement("input", { value: this.state.VaildCodeL, onChange: function onChange(event) {
											return _this2.setState({ VaildCodeL: event.target.value });
										}, type: "text", className: "", id: "VaildCodeL", name: "VaildCode" }),
									_react2.default.createElement("img", { onClick: this.imgClick, src: this.state.imgSrc, className: "img-rounded" })
								),
								_react2.default.createElement(
									"div",
									{ className: "w-100" },
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										"button",
										{ onClick: this.login, type: "button", className: "btn btn-info" },
										"\u767B\u5F55"
									),
									_react2.default.createElement(
										"button",
										{ onClick: this.toRegister, type: "button", className: "btn btn-primary" },
										"\u53BB\u6CE8\u518C"
									)
								)
							)
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								"form",
								{ id: "registerform", className: "form-inline" },
								_react2.default.createElement(
									"h6",
									null,
									"\u5F00\u59CB\u4F60\u7684\u65C5\u884C..."
								...
								_react2.default.createElement(
									...
									_react2.default.createElement("input", { value: this.state.EmailR, onChange: function onChange(event) {
											return _this2.setState({ EmailR: event.target.value });
										}, type: "text", className: "form-control w-75", id: "EmailR", name: "Email" })
								),
								_react2.default.createElement(
									"div",
									{ className: "w-100" },
									...
									_react2.default.createElement("input", { value: this.state.AccountIDR, onChange: function onChange(event) {
											return _this2.setState({ AccountIDR: event.target.value });
										}, type: "text", className: "form-control w-75", id: "AccountIDR", name: "AccountID" })
								),
								_react2.default.createElement(
									"div",
									{ className: "w-100" },
									...
									_react2.default.createElement("input", { value: this.state.PasswordR, onChange: function onChange(event) {
											return _this2.setState({ PasswordR: event.target.value });
										}, className: "form-control w-50", id: "PasswordR", name: "Password", type: "password" })
								),
								_react2.default.createElement(
									"div",
									{ className: "w-100" },
									...
									_react2.default.createElement("input", { value: this.state.PasswordRC, onChange: function onChange(event) {
											return _this2.setState({ PasswordRC: event.target.value });
										}, className: "form-control w-50", id: "PasswordRC", name: "PasswordC", type: "password" })
								),
								_react2.default.createElement(
									"div",
									{ className: "w-100 valid" },
									...
									_react2.default.createElement("input", { value: this.state.VaildCodeR, onChange: function onChange(event) {
											return _this2.setState({ VaildCodeR: event.target.value });
										}, type: "text", className: "", id: "VaildCodeR", name: "VaildCode" }),
									_react2.default.createElement("img", { onClick: this.imgClick, src: this.state.imgSrc, className: "img-rounded" })
								),
								_react2.default.createElement(
									"div",
									...
									_react2.default.createElement(
										"button",
										{ onClick: this.register, type: "button", className: "btn btn-primary" },
										"\u6CE8\u518C"
									),
									_react2.default.createElement(
										"button",
										{ onClick: this.toLogin, type: "button", className: "btn btn-info" },
										"\u53BB\u767B\u5F55"
									)
								)
							)
...
var _Title = __webpack_require__(/*! ./Title.jsx */ "./src/Account/Title.jsx");

var _Title2 = _interopRequireDefault(_Title);

var _Content = __webpack_require__(/*! ./Content.jsx */ "./src/Account/Content.jsx");
