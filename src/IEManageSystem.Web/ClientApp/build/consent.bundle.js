...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Consent/consent.jsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/Consent/authority.jsx":
/*!***********************************!*\
  !*** ./src/Consent/authority.jsx ***!
  \***********************************/
...
var Authority = function (_React$Component) {
	_inherits(Authority, _React$Component);

	function Authority(props) {
		_classCallCheck(this, Authority);

		var _this = _possibleConstructorReturn(this, (Authority.__proto__ || Object.getPrototypeOf(Authority)).call(this, props));

		_this.scopes = new Array();
		_this.state = {
			authorityInfo: null
		};

		_this.GetConsentCall = _this.GetConsentCall.bind(_this);
		_this.AgreeClick = _this.AgreeClick.bind(_this);
		_this.RefuseClick = _this.RefuseClick.bind(_this);
		_this.GetConsent();
		return _this;
	}
	...
	_createClass(Authority, [{
		key: 'GetConsentCall',
		value: function GetConsentCall(data) {
			if (data.isSuccess == true) {
				this.setState({ authorityInfo: data.value });
			} else {
				var errorMessage = "发生了一个错误：" + data.message;
		...
		value: function GetConsent() {
			var returnUrl = escape(GetUrlParam("returnUrl"));
			var url = "/Api/Consent/GetConsent/?returnUrl=" + returnUrl;
		...
		key: 'AgreeClickCall',
		value: function AgreeClickCall(data) {
			if (data.isSuccess == true) {
		...
		value: function render() {
			...
			for (var item in authorityInfo.identityScopes) {
				var li = _react2.default.createElement(
					'li',
					{ className: 'list-group-item list-group-item-success' },
					authorityInfo.identityScopes[item].displayName
				);
				this.scopes.push(authorityInfo.identityScopes[item].name);

				authoritylist.push(li);
			}
			for (var _item in authorityInfo.resourceScopes) {
				var _li = _react2.default.createElement(
					'li',
					{ className: 'list-group-item list-group-item-success' },
					authorityInfo.resourceScopes[_item].displayName
				);
				this.scopes.push(authorityInfo.resourceScopes[_item].name);

				authoritylist.push(_li);
			}

			return _react2.default.createElement(
				'div',
				{ className: 'col-md-8 card float-left authority' },
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'span',
						null,
						authorityInfo.clientName,
						' \u7533\u8BF7\u4EE5\u4E0B\u6743\u9650'
					),
					_react2.default.createElement('span', { id: 'error', className: 'text-danger float-right' })
				),
				_react2.default.createElement(
					'div',
					{ className: 'card-body' },
					_react2.default.createElement(
						'div',
						{ className: 'col-md-12 authority-list' },
					...
					_react2.default.createElement(
						'div',
						{ className: 'col-md-12 authority-btn' },
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'button',
								{ type: 'button', className: 'btn btn-success', onClick: this.AgreeClick },
								'\u540C\u610F\u5E76\u6388\u6743'
							),
							_react2.default.createElement(
								'button',
								{ type: 'button', className: 'btn btn-secondary', onClick: this.RefuseClick },
								'\u62D2\u7EDD\u6388\u6743'
							)
						),
						_react2.default.createElement('div', { className: 'col-md-3' })
...
var _content = __webpack_require__(/*! ./content.jsx */ "./src/Consent/content.jsx");
...
var _authority = __webpack_require__(/*! ./authority.jsx */ "./src/Consent/authority.jsx");

var _authority2 = _interopRequireDefault(_authority);

var _logo = __webpack_require__(/*! ./logo.jsx */ "./src/Consent/logo.jsx");
	...
	_createClass(Content, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'col-md-8' },
				_react2.default.createElement(_authority2.default, null),
...
/******/ });
//# sourceMappingURL=consent.bundle.js.map