...
export default class ClientForm extends React.Component
{
  ...
  submit(){
    ...
    let allowedGrantTypeUl = <FormRadio 
      ...
      onChange={(name, selectValue)=>{this.client.allowedGrantType = selectValue}} />;
    ...
    let identityResourceUl = <FormCheck 
      ...
      onChange={(name, selectValues)=>{this.client.allowedScopes = selectValues}} />
    ...
    let redirectUriGroup = <TextGroup 
      ...
      onChange={(name, values)=>{this.client.redirectUris = values}} />


    let postLogoutRedirectUrisGroup = <TextGroup 
      name="postLogoutRedirectUris"
      values={this.client.postLogoutRedirectUris}
      onChange={(name, values)=>{this.client.postLogoutRedirectUris = values}} />
    ...
    let allowAccessTokensViaBrowserUl = <FormRadio 
      ...
      onChange={(name, selectValue)=>{this.client.allowAccessTokensViaBrowser = selectValue}} />;
    ...
    let accessTokenTypeUl = <FormRadio 
      ...
      onChange={(name, selectValue)=>{this.client.accessTokenType = selectValue}} />;

    let enabledUl = <FormRadio 
      name="enabled" 
      values={[{text:"启用", value:"true"}, {text:"禁用", value:"false"}]} 
      selectValue={this.client.enabled.toString()}
      onChange={(name, selectValue)=>{this.client.enabled = selectValue}} />;

    let allowOfflineAccessUl = <FormRadio 
      name="allowOfflineAccess" 
      values={[{text:"启用", value:"true"}, {text:"禁用", value:"false"}]} 
      selectValue={this.client.allowOfflineAccess.toString()}
      onChange={(name, selectValue)=>{this.client.allowOfflineAccess = selectValue}} />;
            ...
            <div className="modal-content">
              ...
              <div className="modal-body jumbotron">
                <div className="input-group mb-3 col-md-12">
                    ...
                    onChange={event=>{this.client.clientId = event.target.value; this.setState()}} />
                </div>
                <div className="input-group mb-3 col-md-12">
                    <div className="input-group-prepend">
                    ...
                    onChange={event=>{this.client.clientSecret = event.target.value; this.setState()}} />
                </div>
